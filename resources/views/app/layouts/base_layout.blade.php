...
<html lang="en">
	<head>
		...
		-->
		<meta name="description" content="Teknolohiya">
		<!-- /Meta Description -->
		...
		-->
		<meta property="og:title" content="Teknolohiya Inc." />
		<meta property="og:type" content="website" />
		<meta property="og:url" content="www.teknolohiya.ph" />
		<!-- <meta property="og:image" content="https://0.s3.envato.com/files/115761671/Cover_final.__large_preview.png" /> -->
		<meta property="og:site_name" content="Teknolohiya Inc." />
		<!-- /Open Graph Meta -->
		...
		<link rel="stylesheet" href="{{ asset('css/app/slick.css') }}"/>
		<link rel="stylesheet" href="{{ asset('css/app/revolution-slider.css') }}">
		<link rel="stylesheet" href="{{ asset('css/app/bootstrap.css') }}">
		<link rel="stylesheet" href="{{ asset('css/app/min/font-awesome.min.css') }}">
		<link rel="stylesheet" href="{{ asset('css/app/global.css') }}">
		<link rel="stylesheet" href="{{ asset('css/app/components.css') }}">
		<link rel="stylesheet" href="{{ asset('css/app/widgets.css') }}">
		<!-- /Include CSS Files -->
	</head>

	<body class="background--dark nav-default">
	<div class="site style-2">
				...
				<div class="nav-row">
					<div class="container">
						<a href="/" class="site-logo">
							<img src="/images/logos/Logo_White_Transparent_289x289.png">
						</a>
				...
				<div class="footer-content">
					<ul class="contact-info">
						<li>
							...
							<span>02 625 9374</span>
						</li>
						<li>
							<svg class="mail">
								<use xlink:href="#shape-mail"></use>
							</svg>
							<a href="mailto:hello@gfxbucket.com">hello@teknolohiya.ph</a>			
						</li>
						<li>
							<svg class="map-pin">
								<use xlink:href="#shape-map-pin"></use>
							</svg>
							<span>Unit 1, 2399 Belarmino St. Bangkal Makati City, Philippines 1233</span>
						</li>
					</ul>
				</div>
		...
		<!-- Scripts -->
		<script src="{{ asset('js/app/libraries/jquery.min.js') }}"></script>
		<script src="{{ asset('js/app/libraries/isotope.min.js') }}"></script>
		<script src="{{ asset('js/app/libraries/imagesloaded.min.js') }}"></script>
		<script src="{{ asset('js/app/libraries/jquery.parallax.min.js') }}"></script>
		<script src="{{ asset('js/app/libraries/jquery.mb.YTPlayer.js') }}"></script>
		<script src="{{ asset('js/app/libraries/slick.min.js') }}"></script>
		<script src="{{ asset('js/app/libraries/smoothScroll.min.js') }}"></script>
		<script src="{{ asset('js/app/libraries/jquery.validate.min.js') }}"></script>
